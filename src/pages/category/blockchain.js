                            ...
                            {data.map((prod) => (
                                <div key={prod.title1} className="w-full mb-4 sm:w-1/2 md:w-1/3 m-4 p-4 flex lg:w-full justify-between
                                    ...
                                    <div className='g-0 p-8'>
                                        <a href="#">
                                            <img
                                                className="w-[80px] h-[60px] rounded-full object-cover hover:scale-110 transition-transform duration-500" // Changed to rounded-full for profile image
                                                src={prod.profileImage} // Changed to profileImage
                                                alt={prod.name}
                                            />
                                        </a>
                                    </div>
                                    <div className="mb-4">
                                        ...
                                        <Link href={prod.link1}>
                                            <h1 className="mb-2 text-2xl font-bold tracking-tight text-bblack dark:text-white">
                                                {prod.title1}
                                            </h1>
                                        </Link>
