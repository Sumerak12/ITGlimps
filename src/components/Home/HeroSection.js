...
export default function ModernHeroSection() {
  const fullText = "Welcome to ITFlare – simplifying technology's future. Explore the latest in IT, AI, Cloud Computing, and Blockchain!";
  ...
  return (
    ...
    <video
        src="/images/video.mp4" // Path to your video file
        autoPlay
        loop
        muted
        playsInline
        className="w-[98%] h-[98%] object-cover opacity-50"
    />
</div>
