                ...
                <ul className="hidden md:flex space-x-10 text-lg text-[#323232] font-medium">
                    {['Home'].map((item) => (
                        <li key={item} className="relative group">
                            ...
                            >
                                <span className="relative inline-block transition duration-300 transform before:absolute before:bottom-0 before:left-0 before:w-0 before:h-0.5 before:bg-[#323232] hover:before:w-0 before:transition-all before:duration-500 hover:scale-105 no-underline"
                                >{item}</span>
                     ...
                     <li className="relative group">
                        <Link
                            ...
                            className="relative hover:text-black transition duration-300 before:absolute before:bottom-0 before:left-0 before:w-0 before:h-0.5 before:bg-[#323232] hover:before:w-full before:transition-all before:duration-500"
                        >
                            <span className="hover:text-black transition duration-300">Blog</span>
                            <span className="absolute left-0 bottom-0 h-[2px] bg-[#DDD0C8] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                        </Link>
                    </li>
                    ...
                    <li className="relative group">
                        <Link
                            ...
                            className="relative hover:text-black transition duration-300 before:absolute before:bottom-0 before:left-0 before:w-0 before:h-0.5 before:bg-[#323232] hover:before:w-full before:transition-all before:duration-500"
                        >
                            <span className="hover:text-black transition duration-300">About Us</span>
                            <span className="absolute left-0 bottom-0 h-[2px] bg-[#DDD0C8] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                        </Link>
                    </li>
                    <li className="relative group">
                        <Link
                            ...
                            className="relative hover:text-black transition duration-300 before:absolute before:bottom-0 before:left-0 before:w-0 before:h-0.5 before:bg-[#323232] hover:before:w-full before:transition-all before:duration-500"
                        >
                            <span className="hover:text-black transition duration-300">Contact Us</span>
                            <span className="absolute left-0 bottom-0 h-[2px] bg-[#DDD0C8] transform scale-x-0 group-hover:scale-x-100 transition-transform duration-300"></span>
                        </Link>
                    </li>
                </ul>
